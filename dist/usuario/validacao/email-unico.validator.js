...
let EmailUnicoValidator = class EmailUnicoValidator {
    constructor(clsUsuariosAmarzenados) {
        this.clsUsuariosAmarzenados = clsUsuariosAmarzenados;
    }
...
EmailUnicoValidator = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof usuario_dm_1.UsuariosArmazenados !== "undefined" && usuario_dm_1.UsuariosArmazenados) === "function" ? _a : Object])
], EmailUnicoValidator);
